...
fig_scatter = px.scatter(
    ...
    y=f"{pata_y}_{eje_y}",
    opacity=0.6,
    labels={ # Personalización de etiquetas para los ejes y leyendas
...
fig_bar = px.bar(
    ...
    y="Fuerza Promedio (N)",
    color="Pata",
    color_discrete_map=colores_patas, # Aplicamos la paleta de colores
    title="Magnitud de Fuerza Promedio por Pata del Robot",
    labels={"Pata": "Pata del Robot"} # Renombra el eje X
)
